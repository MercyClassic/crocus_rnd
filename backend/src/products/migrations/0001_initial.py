    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=128, unique=True, verbose_name='URL параметр')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Описание')),
                ('image', models.ImageField(upload_to='images/', verbose_name='Изображение')),
                ('price', models.IntegerField(verbose_name='Цена')),
                ('type', models.CharField(blank=True, choices=[('bouquet', 'Букет'), ('box', 'Коробка'), ('basket', 'Корзинка')], db_index=True, max_length=7, null=True, verbose_name='Тип товара')),
