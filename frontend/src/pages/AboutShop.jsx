                    ...
                    <div className="about-us__body">
                        <ul className="about-us__cards-list">
                            ...
                            <li className="about-us__card about-us-card">
                                ...
                                <p className="about-us-card__info">
                                    Крокус -  это самые свежие цветы в Ростове-на-Дону, которые мы доставляем от 1 часа.
                            ...
                            <li className="about-us__card about-us-card">
                                ...
                                <p className="about-us-card__info">
				    Чтобы букет долгое время радовал Вас и Ваших любимых - мы доставляем букеты на воде в аква-боксе, а также прикрепляем инструкцию по уходу за букетом.
                                </p>
                            </li>
                            <li className="about-us__card about-us-card">
                                <div className="about-us-card__image-wrapper">
                                ...
                                <p className="about-us-card__info">
                                    ...
                                    Порадуйте своих близких авторскими букетами от Крокус!
                                </p>
                            </li>
                        </ul>
                    </div>
