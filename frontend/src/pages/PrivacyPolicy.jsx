                    ...
                    <div className="creator-letter__container">
                        ...
                        <div className="creator-letter__body _letter">
                            <p className="creator-letter__text">
                                Настоящее Положение о политике конфиденциальности персональных данных (далее – Положение) действует в отношении всей информации, которую Интернет-магазин Крокус рнд, расположенный на доменном имени https://crocus-rnd.ru/, может получить о Пользователе во время использования сайта Интернет-магазина, программ и продуктов Интернет-магазина.
                            </p>
                            <p className="creator-letter__text">
                        ...
                        <div className="creator-letter__body _letter">
                            ...
                            <p className="creator-letter__text">
                                ...
                                Крокус рнд может использовать файлы cookie для того, чтобы:
                            </p>
                            <p className="creator-letter__text">
                                Обеспечивать функционирование и безопасность сайта.
                                Улучшать качество сайта.
                                Предоставлять информацию о компании Крокус рнд, ее продуктах и услугах.
                                На основании данных, полученных с помощью файлов cookie, компания Крокус рнд разрабатывает наиболее полезный функционал для сайта, которым Вы пользуетесь, проводит статистические и маркетинговые исследования, исправляет ошибки сайта и тестирует новые функции для повышения производительности сайта, персонализирует их и показывает наиболее релевантную для вас информацию.
                            </p>
                            <p className="creator-letter__text">
                            ...
                            <p className="creator-letter__text">
                                ...
                                Используемые Вами браузер и (или) устройство могут позволять Вам блокировать, удалять или иным образом ограничивать использование фалов cookie. Но файлы cookie являются важной частью сайта компании Крокус рнд в сети «Интернет», поэтому блокировка, удаление или ограничение их использования может привести к тому, что Вы будете иметь доступ не ко всем функциям сайта.
                            </p>
                            <p className="creator-letter__text">
