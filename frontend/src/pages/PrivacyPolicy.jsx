                ...
                <section className="creator-letter">
                    <div className="creator-letter__container">
                        ...
                        <div className="creator-letter__body _letter">
                            ...
                            <p className="creator-letter__text">
                                1.1.1.Оферта — настоящий документ (Соглашение), размещенный в сети Интернет по адресу: <Link to="https://crocus-rnd.ru/"> https://crocus-rnd.ru/. </Link>
                            </p>
                            <p className="creator-letter__text">
                            ...
                            <p className="creator-letter__text">
                                2.1. Настоящее Соглашение определяет условия и порядок использования Пользователем Интернет-магазина – <Link to="https://crocus-rnd.ru/"> https://crocus-rnd.ru/, </Link> который принадлежит и администрируется Правообладателем (далее по тексту - Сайт).
                            </p>
                            <p className="creator-letter__text">
                            ...
                            <p className="creator-letter__text">
                                2.4. Заказывая Товары через Сайт, Пользователь соглашается с условиями продажи Товаров, расположенными по ссылке: <Link to="{% url 'products:privacy_policy' %}"> https://crocus-rnd.ru/privacy_policy. </Link>
                            </p>
                            <p className="creator-letter__text">
                            ...
                            <p className="creator-letter__text">
                                2.7. Перед заказом Товара Пользователь обязуется ознакомиться с правилами доставки и оплаты заказа, а также условиями возврата Товара, расположенными по ссылке:  <Link to="{% url 'products:privacy_policy' %}"> https://crocus-rnd.ru/privacy_policy. </Link>
                            </p>
                            <p className="creator-letter__text">
                            ...
                            <p className="creator-letter__text">
                                3.5. Оферта вступает в силу с момента размещения в сети Интернет по адресу  <Link to="{% url 'products:privacy_policy' %}"> https://crocus-rnd.ru/privacy_policy </Link> и действует до момента отзыва оферты.
                            </p>
                            <p className="creator-letter__text">
                            ...
                            <p className="creator-letter__text">
                                4.1.4. Предоставлять информацию по вопросам работы с Сайтом посредством электронной почты. Актуальные адреса электронной почты находятся в разделе "Контакты" Сайта по адресу:  <Link to="{% url 'products:contact_information' %}"> https://crocus-rnd.ru/contact_information. </Link>
                            </p>
                            <p className="creator-letter__text">
