                    ...
                    <ul className="footer__list">
                        <li className="footer__item item-footer">
                            ...
                            <ul className="item-footer__sub-list">
                                ...
                                <li className="item-footer__sub-item">
                                    <Link to="https://wa.me/79185212571" className="item-footer__sub-link">WhatsApp +7 (918) 521-25-71</Link>
                                </li>
                                <li className="item-footer__sub-item">
                                    <Link className="item-footer__sub-link">Почта crocusrnd@mail.ru</Link>
                                </li>
                                <li className="item-footer__sub-item">
                                    <Link to="tel: +7 (918) 521-25-71" className="item-footer__sub-link">Телефон +7 (918) 521-25-71</Link>
                                </li>
                            </ul>
                        </li>
                        <li className="footer__item item-footer">
                            ...
                            <ul className="item-footer__sub-list">
                                <li className="item-footer__sub-item">
                                    <Link to="https://instagram.com/crocusrnd/" className="item-footer__sub-link">Инстаграм</Link>
                                </li>
                                <li className="item-footer__sub-item">
                                    <Link to="https://wa.me/79185212571" className="item-footer__sub-link">Whatsapp</Link>
                                </li>
                                <li className="item-footer__sub-item">
                                    <Link to="https://t.me/crocus_rnd/" className="item-footer__sub-link">Телеграм</Link>
                                </li>
                            </ul>
                        </li>
                        <li className="footer__item item-footer">
                            ...
                            <ul className="item-footer__sub-list">
                                ...
                                <li className="item-footer__sub-item">
                                    <Link to="https://instagram.com/crocusrnd/" className="item-footer__sub-link">Инстаграм @crocusrnd</Link>
                                </li>
                                <li className="item-footer__sub-item">
                                    <Link className="item-footer__sub-link">Почта crocusrnd@mail.ru</Link>
                                </li>
                    ...
                    <div className="footer__content-container _container">
                        ...
                        <ul className="footer__socials-list footer-socials">
                            <li className="footer-socials__item">
                                <Link to="https://wa.me/79185212571" className="footer-socials__link">
