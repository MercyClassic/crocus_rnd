    ...
    return(
        <>
            ...
            <div className="popup-cart__input-phone-wrapper">
                ...
                <input type="text" onClick={(e) => formatPhoneNumber(e)} placeholder="Например: +7 (999) 777-77-77" className="popup-cart__phone-input _input" name="receiver_phone_number" required
            ...
            <div className="popup-cart__input-name-wrapper">
                ...
                <input type="text" className="popup-cart__name-input _input" name="promo_code" placeholder="Промокод (при наличии)" maxLength="25"/>
            </div>
            <div className="popup-cart__set-promo_code-button-wrapper">
                <button onClick={(e) => setPromoCode(e)} className="popup-cart__set-promo_code-button _black-button-promo-code">Применить промокод</button>
            </div>
